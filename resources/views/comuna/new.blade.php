...
<html lang="en">
  <head>
    ...
    <title>Añadir Columna</title>
  </head>
  <body>
    <div class="container">
    <h1>Añadir Columna</h1>
    <form method="POST" action="{{ route('comunas.store')}}">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="name" arial-describedby="nameHelp" name="name" placeholder="communa name">
        </div>
